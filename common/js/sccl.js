...
$(".header-menu-btn").click(function(){
	...
	var marginleft=$('.min-menu-panel').css('margin-left').replace('px','');
	if(marginleft==0){
        $('.min-menu-panel').animate({marginLeft:$(window).width()});
        count++;
    }
});
...
$('.header-menu-toggle-btn').click(function () {
		if(count%2==0){
            $('.min-menu-panel').animate({marginLeft:0});
	}else {
            $('.min-menu-panel').animate({marginLeft:$(window).width()});
        }
        if($(".layout-side").css('display')=='block'){
						...
						{"id":"12","name":"一级","parentId":"10","url":"","icon":"","order":"1","isHeader":"0","childMenus":[
							...
							{"id":"14","name":"二级","parentId":"12","url":"","icon":"","order":"1","isHeader":"0","childMenus":[
								...
								{"id":"16","name":"三级","parentId":"14","url":"","icon":"","order":"1","isHeader":"0","childMenus":[
									...
									{"id":"19","name":"四级","parentId":"16","url":"","icon":"","order":"1","isHeader":"0","childMenus":""},
									{"id":"19","name":"四级","parentId":"16","url":"","icon":"","order":"1","isHeader":"0","childMenus":""},
									{"id":"20","name":"四级","parentId":"16","url":"","icon":"","order":"1","isHeader":"0","childMenus":""},
									{"id":"21","name":"四级","parentId":"16","url":"","icon":"","order":"1","isHeader":"0","childMenus":""}
								]}
							]}
						]}
					]}
